...
> 人学习先进的方法论，能够提升解决问题的能力。那 AI 呢？
> 我们挑了五种经典思想流派，各写成一套 prompt 注进 agent，用基准测试量化结果。
> 那就在 benchmark 上比一比，用数据量化先进思想对 agent 能力的提升。

评测太耗token了，家贫无高浓度token，所以评的数据量级少，仅供参考，望体谅！
